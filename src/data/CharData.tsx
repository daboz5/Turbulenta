...
export default function CharData() {
    ...
    const chars: Char[] = [{
        ...
        desc: <>
            {`Remember Me is a feygol, a creature druidcrafted from natural materials and magic (usually inhabited by a fey-spirit, thus fey golem).`}<br />
            {`Feygols may change shells or shape as they grow, so Remember Me also changes shape and grows as it levels up. They usually need caster's magic to sustain themselves or magic of the places or artefacts they guard, making them to some extent dependent on their source of magic, but as Emily gave her life to create Remember Me, she also enabled it to carry its source of magic within its body, making it independent.`}<br />
            {`At the beginning, it was a mostly metal construct given life by Emily from many different schools and types of magic, but soon nature replace most of the metal and replaced it with stone and wood as its druidic and faywild nature started to prevail.`}<br />
            {`Mostly made out of stone, later connecting it with roots, covered by moss, with a bright light comming out of its eye-holes. In later life it also learned to immitate breathing, but not with using mouths, air entering and leaving from the side of its body.`}<br />
            {`Remember Me with years grew quite a proficient talker and entertainer as it is constantly talking or performing about Emily, its creator and its life mission, but is not very smart. He is capable to be very wise, but his memory for everything except Emily is rather crude, his understanding of a world lacking and his writting resembling that of a young child. He will often not recognise common concepts and will remember people by their craft or their relation to it instead of by their name.`}<br />
            {`Even so, Rememeber Me will put a great effort into most of what it does, just as Emily would. Due to Emily's long life and being in posession of all of her memories, he might be able to at times performed striking feats of intelligence, even if it is a mostly borrowed knowladge and his interpretation of memories can be lacking.`}<br />
            {`Feygol wanted to live its life in a way Emily would be proud on it, so when not dedicating it to spreading word about her, it often tried to find ways how to help people, especially those that reminded Remember Me of Emily (disabled, sickly, people in need of help and backing).`}<br />
            {`Remember Me gave his life to its own construction, statue of Emily, in hope it would serve its creator better than it was ever able to do by itself, but also in hope that Emily itself might be able to more freely express itself in its creation, its last words: "Remember me, Emily.".`}
        </>,
        companions: [{
            name: "Repko",
            token: repko,
